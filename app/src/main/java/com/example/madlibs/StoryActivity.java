...
public class StoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String strToDisplay = "One day in a "+ myAdj + " land, a(n) " + myNoun + " by the name of "
                ...
                "going as planned at all! In a blink of an eye, " + myName + " had a family and two " +
                ...
                + myVerb + " and suddenly scream \"" + myPhrase + "\"";
